...
import placeholder from "../public/imagens/placeholder.png";
    ...
    <main className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          <div className="mb-8">
            <div className="inline-block p-5 mb-4">
              <Image
                src={logo}
                alt="Logo"
                width={120}
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <Image
              ...
              alt="Maria Julia Ramos"
              width={300}
              height={400}
              className="rounded-lg"
            />
            <div className="space-y-4">
              <h3 className="text-xl font-bold">Maria Julia Ramos</h3>
              ...
              <p className="text-gray-600">
                ...
                compromisso de oferecer um serviço psicológico de qualidade e
                humanizado.
              </p>
              <Link
                href="https://wa.me/48988646542"
      ...
      <footer className="py-8 border-t">
        <div className="max-w-6xl mx-auto px-4 text-center text-sm text-gray-600">
          ...
          <p className="mt-2">CRP XX/XXXXX</p>
        </div>
      </footer>
    </main>
  );
